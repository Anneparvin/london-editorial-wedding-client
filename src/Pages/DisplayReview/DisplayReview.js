...
const DisplayReview = ({_id}) => {
    ...
    return (
        <div>
        <div>
        <h2 className='text-2xl font-bold text-center mt-12'>All Reviews By Clients</h2>
        </div>
            ...
            review.map((item, index) =>
                ...
                <div className="flex justify-between p-4">
                    <div className="flex space-x-4">
                        <div>
                            <img src={item.img} alt="" className="object-cover w-12 h-12 rounded-full dark:bg-gray-500" />
                        </div>
                        <div>
                            <h4 className="font-bold">{item.customer}</h4>
                            <span className="text-xs dark:text-gray-400">{item.publishTime}</span>
                        </div>
                    </div>
